      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputs}>
          ...
          />
            ...
            <TouchableOpacity style={styles.btn} onPress={()=> this.pickColor('red')}>
              <Text style={styles.btnTxt}>Red</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.btn} onPress={()=> this.pickColor('blue')}>
              <Text style={styles.btnTxt}>Blue</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.btn} onPress={()=> this.pickColor('green')}>
